...
INSERT INTO tbl_products (id, name, description, stock, price, status, create_at, categorie_id)
VALUES (1, 'adidas Cloudfoam Ultimate',
        'Walk in the air in the black / black CLOUDFOAM ULTIMATE running shoe from ADIDAS', 5, 178.89, 'CREATED',
        '2018-09-05', 1);

INSERT INTO tbl_products (id, name, description, stock, price, status, create_at, categorie_id)
VALUES (2, 'under armour Men ''s Micro G Assert – 7',
...
INSERT INTO tbl_products (id, name, description, stock, price, status, create_at, categorie_id)
VALUES (3, 'Spring Boot in Action',
